<?php 
    ...
    if(isset($_POST['update'])){
        ...
        if(!empty($_FILES['gambar']['name'])){
            $query = mysqli_query($connect,"SELECT * FROM menu WHERE nama_menu='$namaMenu'");
            ...
            if(move_uploaded_file($tmp,"../img/$gambar_baru")){
                $query1 = mysqli_query($connect, "UPDATE images SET id_menu='$id', nama_gambar='$nama', upload_on='$waktu', file='$gambar_baru' WHERE id_menu='$idMenu'");
