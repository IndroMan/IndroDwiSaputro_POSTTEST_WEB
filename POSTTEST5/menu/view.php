    ...
    <form action="" method="POST">
        ...
        <table align="center" border="0" class="table">
            <tr>
                ...
                <?php
                    $no = 1;
                    $tableBarang = mysqli_query($connect, "SELECT * FROM menu");
            ...
            <tr>
                ...
                <td><a href="update.php?id=<?= $rowBarang['id_menu']?>"><i class="fa-solid fa-pen"></i></a> | <a href="delete.php?id=<?= $rowBarang['id_menu'] ?>"><i class="fa-solid fa-trash"></i></a></td>
            </tr>
